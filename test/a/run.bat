...
:build_share
    ...
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f a-share
	call %MVN_EXEC% clean package -pl a-share,a-share-docker
EXIT /B 0
:build_acs
    docker-compose -f "%COMPOSE_FILE_PATH%" kill a-acs
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f a-acs
	call %MVN_EXEC% clean package -pl a-integration-tests,a-platform,a-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl a-platform,a-integration-tests,a-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl a-platform,a-integration-tests
EXIT /B 0
:purge
